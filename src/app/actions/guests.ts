...
export async function draftSMS(guest: Guest) {
  return `Hi ${guest.name.split(" ")[0]}! We've missed you at Davie Pilot. We're craving your favorite ${guest.favorite_item} and would love to see you soon. Use code WELCOMEBACK for a complimentary appetizer this weekend!`;
}
